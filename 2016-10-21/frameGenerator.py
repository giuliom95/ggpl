...
def createPillarBases(pillarSection, pillarDistances):
    ...
    tempList = []
    invertedPillarDistances = [-pillar for pillar in pillarDistances]  # Inverts the elements of the list
    for pillar in invertedPillarDistances:
        tempList.append(pillarSection[1])
        tempList.append(pillar)
    tempList.append(pillarSection[1])
